  ...
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.only(
        left: MediaQuery.of(context).padding.left == 0 ? Spacing.md : MediaQuery.of(context).padding.left,
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(DurationHelper.toFormattedTime(Duration(seconds: score.secondsElapsed))),
          ),
          Expanded(
